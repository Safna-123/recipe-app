        ...
        <div className="row">
            <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div className="row g-3">
                    ...
                    <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <label htmlFor="" className="form-label">Recipes</label>
                        <select name="" id="" className="form-select">
                            <option value="Select Recipe">Select Recipe</option>
                            <option value="">Chicken Biriyani</option>
                            <option value="">Paneer Bhurji</option>
                            <option value="">Alfam</option>
                            <option value="">Masala Dosa</option>
                            <option value="">Friedrice</option>
                            <option value="">Veg Noodles</option>
                            <option value="">Macroni</option>
                        </select>
                    </div>
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
